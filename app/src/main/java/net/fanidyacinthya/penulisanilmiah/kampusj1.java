...
public class kampusj1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_kampusj1);
    }

    public void informasi(View view) {
        Intent info = new Intent(this, infokampusj1.class);
        startActivity(info);
    }

    public void lokasi(View view) {
        Intent lok = new Intent(this, mapsj1.class);
        startActivity(lok);
    }
