...
public class kampusj5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_kampusj5);
    }

    public void informasi(View view) {
        Intent info = new Intent(this, infokampusj5.class);
        startActivity(info);
    }

    public void lokasi(View view) {
        Intent lok = new Intent(this, mapsj5.class);
        startActivity(lok);
    }
